...
import { Send, Calendar, Plane, Info, Plus, History, ChevronLeft } from "lucide-react";
...
function PassagensDiariasPage() {
  ...
  const [includeDesloc, setIncludeDesloc] = useState(false);
  ...
  const canSubmit = passengerName.trim() !== "" && passengerEmail.trim() !== "" && passengerCPF.trim() !== "" && localPartida.trim() !== "" && localChegada.trim() !== "" && missionStart.trim() !== "" && missionEnd.trim() !== "";
            ...
            {sent && saved ? (
              ...
              <>
                ...
                <section className="rounded-xl border bg-card p-6 mb-6">
                  <div className="text-sm font-semibold mb-2">Seção 1: Identificação e Destino</div>
                  <div className="grid gap-3">
                    <label className="mb-3">
                      <div className="text-sm font-medium">1. Projeto Vinculado</div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <label className="mb-3">
                        <div className="text-sm font-medium">2. Nome do passageiro</div>
                      ...
                      <label className="mb-3">
                        <div className="text-sm font-medium">3. E-mail do passageiro</div>
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                      <label className="mb-3">
                        <div className="text-sm font-medium">4. RG do passageiro</div>
                        <input value={passengerRG} onChange={(e) => setPassengerRG(e.target.value)} placeholder="RG" className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground" />
                      </label>
                      <label className="mb-3">
                        <div className="text-sm font-medium">5. CPF do passageiro</div>
                      ...
                      <label className="mb-3">
                        <div className="text-sm font-medium">6. Data de nascimento do passageiro</div>
                        <div className="relative mt-2">
                          <Calendar className="size-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                          <input value={passengerDOB} onChange={(e) => setPassengerDOB(formatDateDDMMYYYY(e.target.value))} placeholder="DD/MM/AAAA" inputMode="numeric" maxLength={10} className="w-full rounded-lg border pl-10 pr-3 py-2 bg-white text-foreground" />
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="grid gap-4">
                      <label className="mb-3">
                        <div className="text-sm font-medium">7. Telefone de contato</div>
                        <input value={passengerPhone} onChange={(e) => setPassengerPhone(e.target.value)} placeholder="Telefone" className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground" />
                      </label>
                      <label className="mb-3">
                        <div className="text-sm font-medium">8. Confirmação de Pagamento</div>
                        <div className="mt-2 text-sm">
                          <label className="inline-flex items-start gap-2"><input type="checkbox" checked={paymentConfirmation} onChange={(e) => setPaymentConfirmation(e.target.checked)} /> <span>Declaro estar ciente de que o pagamento será realizado exclusivamente via transferência PIX, utilizando como chave o CPF informado nesta solicitação.</span></label>
                        </div>
                      </label>
                    </div>
                  </div>
                ...
                <section className="rounded-xl border bg-card p-6 mb-6">
                  <div className="text-sm font-semibold mb-2">Seção 2: Definição da Missão e do Destino</div>
                  <div className="grid gap-3">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <label className="mb-3">
                        <div className="text-sm font-medium">9. Local de partida</div>
                      ...
                      <label className="mb-3">
                        <div className="text-sm font-medium">10. Local de chegada</div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <label className="mb-3">
                        <div className="text-sm font-medium">11. Data de início da missão/evento</div>
                        <div className="relative mt-2">
                          <Calendar className="size-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                      ...
                      <label className="mb-3">
                        <div className="text-sm font-medium">12. Data de término da missão/evento</div>
                        <div className="relative mt-2">
                          <Calendar className="size-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                    ...
                    <label className="mb-3">
                      <div className="text-sm font-medium">13. Tipo de despesa</div>
                      <select value={expenseType} onChange={(e) => setExpenseType(e.target.value)} className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground">
                    ...
                    <label className="mb-3">
                      <div className="text-sm font-medium">14. Selecione o tipo da sua solicitação</div>
                      <select value={requestKind} onChange={(e) => setRequestKind(e.target.value)} className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground">
                ...
                <section className="rounded-xl border bg-card p-6 mb-6">
                  <div className="text-sm font-semibold mb-2">Seção 3: Seção de Diárias</div>
                  <div className="grid gap-3">
                    <label className="mb-3">
                      <div className="text-sm font-medium">15. Estime a quantidade de diárias</div>
                    ...
                    <label className="mb-3">
                      <div className="text-sm font-medium">16. Incluir adicional de deslocamento?</div>
                      <div className="mt-2 inline-flex items-center gap-4">
                        <label className="inline-flex items-center gap-2"><input type="radio" name="desloc" checked={includeDesloc} onChange={() => setIncludeDesloc(true)} /> Sim</label>
                        <label className="inline-flex items-center gap-2"><input type="radio" name="desloc" checked={!includeDesloc} onChange={() => setIncludeDesloc(false)} /> Não</label>
                      </div>
                    </label>
                  </div>
                </section>
                ...
                <section className="rounded-xl border bg-card p-6 mb-6">
                  <div className="text-sm font-semibold mb-2">Seção 4: Passagens e Voos</div>
                  <div className="grid gap-3">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <label className="mb-3">
                        <div className="text-sm font-medium">17. Data de Ida</div>
                        <div className="relative mt-2">
                          <Calendar className="size-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                      ...
                      <label className="mb-3">
                        <div className="text-sm font-medium">18. Data de Volta</div>
                        <div className="relative mt-2">
                          <Calendar className="size-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                    ...
                    <label className="mb-3">
                      <div className="text-sm font-medium">19. Sua viagem é internacional?</div>
                      <div className="mt-2 inline-flex items-center gap-4">
                    ...
                    {international === true && (
                      <div className="mt-4 space-y-4">
                        <div>
                          <div className="text-sm font-medium">20. Irá precisar de seguro viagem ?</div>
                          <div className="mt-2 inline-flex items-center gap-4">
                        ...
                        {travelInsurance === true && (
                          <div className="space-y-3">
                            ...
                            <label className="mb-3">
                              <div className="text-sm font-medium">22. Informe o número do seu contato de emergência:</div>
                              <div className="text-xs text-muted-foreground">Caso não precise de seguro viagem, digite: NÃO SE APLICA</div>
                            ...
                            <label className="mb-3">
                              <div className="text-sm font-medium">23. Informe o endereço com CEP do seu contato de emergência:</div>
                              <div className="text-xs text-muted-foreground">Caso não precise de seguro viagem, digite: NÃO SE APLICA</div>
                            ...
                            <label className="mb-3">
                              <div className="text-sm font-medium">24. Número do passaporte:</div>
                            ...
                            <label className="mb-3">
                              <div className="text-sm font-medium">25. Envio da imagem do passaporte</div>
                        ...
                        {travelInsurance === false && (
                          <div className="space-y-3">
                            <label className="mb-3 pt-4">
                              <div className="text-sm font-medium">21. Número do passaporte:</div>
                              <input value={passportNumberIntl} onChange={(e) => setPassportNumberIntl(e.target.value)} placeholder="Insira sua resposta" className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground" />
                            </label>

                            <label className="mb-3">
                              <div className="text-sm font-medium">22. Envio da imagem do passaporte</div>
                              <div className="mt-2 text-sm text-muted-foreground">clique no link abaixo para enviar a imagem do passaporte do passageiro:<br /><a className="text-primary underline" href="https://ceiaufg.sharepoint.com/:f:/s/CentraldeSolicitacoes/ErsXaua7A-FJvcY3oSVd5P8B1NNfzeMuknO2KtZHf6USHg" target="_blank" rel="noreferrer">Envio Passaporte</a></div>
                              <div className="text-xs text-muted-foreground mt-2">1- O arquivo deve ser nomeado como: Passaporte<br/>2-Ao acessar o link, preencha seus dados (nome e sobrenome) conforme solicitado<br/>Essas informações são usadas para identificar corretamente o autor do envio.</div>
                              <label className="inline-flex items-start gap-2 mt-2"><input type="checkbox" checked={passportUploadedConfirm} onChange={(e) => setPassportUploadedConfirm(e.target.checked)} /> <span className="text-sm">Confirmo que realizei o upload da imagem do passaporte com o nome correto (Passaporte) e que preenchi meu nome completo na tela de envio.</span></label>
                            </label>
                          ...
                          <>
                                    {travelInsurance !== null && (
                                      <>
                                        ...
                                        <label className="mb-3 pt-4">
                                          <div className="text-sm font-medium">26. Tipo de Transporte:</div>
                                          ...
                                          <select value={transportType} onChange={(e) => setTransportType(e.target.value)} className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground">
                                        ...
                                        <label className="mb-3">
                                          <div className="text-sm font-medium">27. Incluir franquia de bagagem?</div>
                    ...
                    {international === false && (
                      <>
                        <label className="mb-3 pt-4">
                          <div className="text-sm font-medium">20. Tipo de Transporte:</div>
                          <div className="text-xs text-muted-foreground">A passagem de transporte rodoviário é adquirida pelo passageiro e reembolsada posteriormente.</div>
                          <select value={transportType} onChange={(e) => setTransportType(e.target.value)} className="mt-2 w-full rounded-lg border px-3 py-2 bg-white text-foreground">
                            <option value="">Selecionar sua resposta</option>
                            <option value="aereo">Aéreo</option>
                        ...
                        <label>
                          <div className="text-sm font-medium">21. Incluir franquia de bagagem?</div>
                          <div className="mt-2 text-xs text-muted-foreground">Após a compra da passagem não é mais possível incluir bagagens pagas com recurso do projeto, apenas com recurso próprio do passageiro.</div>
                          <div className="mt-2 inline-flex items-center gap-4">
                            <label className="inline-flex items-center gap-2"><input type="radio" name="bagagem" checked={includeBaggage} onChange={() => setIncludeBaggage(true)} /> Sim</label>
                ...
                <section className="rounded-xl border bg-card p-6 mb-6">
                  <div className="text-sm font-semibold mb-2">Seção 5: Restrições e Preferências</div>
                  <div className="grid gap-3">
                    <label>
                      <div className="text-sm font-medium">20. Possui restrição de Voo?</div>
                      <div className="mt-2 inline-flex items-center gap-4">
                    ...
                    {flightRestriction === true && (
                      <>
                        <label className="mb-3">
                          <div className="text-sm font-medium">23. Informe os horários preferenciais</div>
                        ...
                        <label className="mb-3">
                          <div className="text-sm font-medium">24. Possui preferência de voo?</div>
                          <div className="mt-2 inline-flex items-center gap-4">
                        ...
                        {flightPreference === true && (
                          <label className="mb-3">
                            <div className="text-sm font-medium">25. Por favor, anexe o arquivo com a pesquisa, contendo: data, companhia aérea, horário e valor do voo.</div>
                            ...
                            <div className="text-xs text-muted-foreground mt-2">1- O arquivo deve ser nomeado como: Pesquisa.pdf<br/>2-Ao acessar o link, preencha seus dados (nome e sobrenome) conforme solicitado<br/> Essas informações são usadas para identificar corretamente o autor do envio.</div>
                    ...
                    {flightRestriction === false && (
                      <>
                        <label>
                          <div className="text-sm font-medium">23. Possui preferência de voo?</div>
                          <div className="mt-2 inline-flex items-center gap-4">
                        ...
                        {flightPreference === true && (
                          <label>
                            <div className="text-sm font-medium">24. Por favor, anexe o arquivo com a pesquisa, contendo: data, companhia aérea, horário e valor do voo.</div>
                            <div className="mt-2 text-sm text-muted-foreground">clique no link abaixo para enviar:<br /><a className="text-primary underline" href="https://ceiaufg.sharepoint.com/:f:/s/CentraldeSolicitacoes/EnIaDA1igR9Kg_Z4PhSJLocB3OhGjpVHWMdBE8VmibGNbQ" target="_blank" rel="noreferrer">Envio Sugestão</a></div>
                            <div className="text-xs text-muted-foreground mt-2">1- O arquivo deve ser nomeado como: Pesquisa.pdf<br/>2-Ao acessar o link, preencha seus dados (nome e sobrenome) conforme solicitado<br/> Essas informações são usadas para identificar corretamente o autor do envio.</div>
                            <label className="inline-flex items-start gap-2 mt-2"><input type="checkbox" checked={uploadedConfirm} onChange={(e) => setUploadedConfirm(e.target.checked)} /> <span className="text-sm">Confirmo que realizei o upload do arquivo com o nome correto (Pesquisa.pdf) e que preenchi meu nome completo na tela de envio.</span></label>
                          </label>
                ...
                <section className="rounded-xl border bg-card p-6 mb-6">
                  <div className="text-sm font-semibold mb-2">Seção 6: Objetivo da Viagem</div>
                  <div className="grid gap-3">
                    <label className="mb-3">
                      <div className="text-sm font-medium">25. Observação importante ou comentário</div>
                    ...
                    <label className="mb-3">
                      <div className="text-sm font-medium">26. Descrição das atividades a serem executadas</div>
                    ...
                    <label className="mb-3">
                      <div className="text-sm font-medium">27. Justificativa para solicitação com menos de 20 dias</div>
